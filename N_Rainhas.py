...
'''
Explicação das mudanças feitas no POPULATION_SIZE e MUTATION_RATE:

População:
  Aumentar:
    Maior diversidade e mais soluções, mas é lento;
    Maior chance de encontrar soluções ideais.
  Diminuir:
    Gerações mais rápidas, mas com pouca diversidade.


Mutação:
  Aumentar:
    Mantém diversidade, mas pode perder boas soluções já encontradas e gera ruídos dificultando a convergência.
  Diminuir:
    Preservar soluções boas, mas o algoritmo pode estagnar;
'''
